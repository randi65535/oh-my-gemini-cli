...
| 기본 모델 전략 | 계획/아키텍처는 `gemini-3.1-pro`, 실행 중심 작업은 `gemini-3-flash`, 작고 저위험한 수정은 `gemini-3.1-flash-lite` |
...
| `omg-executor` | 빠른 구현 사이클 | `gemini-3-flash` |
...
| `omg-quick` | 의도된 적은 수정 | `gemini-3.1-flash-lite` |
